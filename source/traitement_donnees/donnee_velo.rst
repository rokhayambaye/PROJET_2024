...
- Télécharger les données de trajets et des stations.
- Nettoyer les noms des stations.
- Ajouter les coordonnées (latitude et longitude) aux stations de départ et d'arrivée des trajets.
