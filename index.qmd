...
format:
  html:
    ...
    toc-title: "Sommaire"
    code-fold: true
    css: styles.css  # Chemin relatif correct pour le CSS
    theme: flatly    # Thème de base Quarto
---
...
<video controls width="100%" height="auto">
  <source src="docs/Video/bike_animation_12_Mai.mp4">
</video>

<video controls width="100%" height="auto">
  <source src="docs/Video/bike_animation_14_Mai.mp4">
</video>
...
## Documentation
Si vous souhaitez en apprendre plus, nous mettons à votre disposition la documentation permettant d'installer et de suivre notre démarche : [__Documentation__](docs/build/html/index.html).